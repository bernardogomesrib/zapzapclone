...
export function postMessageWithFile(http: HttpClient, rootUrl: string, params: PostMessageWithFile$Params, context?: HttpContext): Observable<StrictHttpResponse<MessageResponse>> {
