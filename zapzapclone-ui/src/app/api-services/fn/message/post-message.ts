...
export function postMessage(http: HttpClient, rootUrl: string, params: PostMessage$Params, context?: HttpContext): Observable<StrictHttpResponse<MessageResponse>> {
